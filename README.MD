...
- [Spigot](https://spigotmc.org/) or [Paper](https://papermc.io/) 1.8.8 - 1.18.2
- [SirBlobmanCore](https://jenkins.sirblobman.xyz/job/SirBlobman/job/SirBlobmanAPI/) 2.3.6 or higher.
