...
/**
 * PlayerTagEvent is an event that will be fired when a player is put into combat.
...
public class PlayerTagEvent extends CustomPlayerEvent {
    ...
    public PlayerTagEvent(Player player, LivingEntity enemy, PlayerPreTagEvent.TagType tagType, PlayerPreTagEvent.TagReason tagReason, long combatEnds) {
        super(player);
        this.enemy = enemy;
