...
public enum NoEntryMode {
    ...
    /** The player will be pushed away from the region with velocity.
     * This option may trigger some anti-cheat plugins. */
    KNOCKBACK_PLAYER;

    /**
     * @param string The string to parse.
     * @return A {@link NoEntryMode} that matches the uppercase value of the string or {@link #DISABLED}
