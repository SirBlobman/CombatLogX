...
public class CombatEvent extends Event implements Cancellable {
    ...
    /**
     * An event that will be called when two entities attack each other and both of
     * them can be tagged<br/>
     * This version does not detect if an entity is a player or not
     * 
     * @param le1
     *            The 1<sup>st</sup> entity which is involved
     * @param le2
     *            The 2<sup>nd</sup> entity which is involved
     * @param attacker
     *            Is the first entity the attacker?
     */
