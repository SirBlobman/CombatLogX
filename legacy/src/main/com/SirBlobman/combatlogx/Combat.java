...
public class Combat implements Runnable {
     ...
     * @param enemy The entity that cause them to be put into combat (can be
     *              {@code null})
    ...
    public static void tag(Player p, @Nullable LivingEntity enemy) {
        ...
        if (!disabled.contains(world)) {
            boolean bypass = (ConfigOptions.OPTION_BYPASS_ENABLE
                    && p.hasPermission(ConfigOptions.OPTION_BYPASS_PERMISSION));
            if (!bypass) {
