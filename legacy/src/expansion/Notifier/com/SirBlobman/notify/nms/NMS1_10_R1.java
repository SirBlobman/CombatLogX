...
public class NMS1_10_R1 extends NMSUtil {
    @Override
    public void action(Player player, String msg) {
        try {
            ...
            Class<?> class_IChatBaseComponent = Class.forName("net.minecraft.server.v1_10_R1.IChatBaseComponent");
            Class<?> class_ChatSerializer = ReflectionUtil.getInnerClass(class_IChatBaseComponent, "ChatSerializer");
            Class<?> class_CraftPlayer = Class.forName("org.bukkit.craftbukkit.v1_10_R1.entity.CraftPlayer");
            Class<?> class_PacketPlayOutChat = Class.forName("net.minecraft.server.v1_10_R1.PacketPlayOutChat");
            Class<?> class_EntityPlayer = Class.forName("net.minecraft.server.v1_10_R1.EntityPlayer");
            Class<?> class_PlayerConnection = Class.forName("net.minecraft.server.v1_10_R1.PlayerConnection");
            Class<?> class_Packet = Class.forName("net.minecraft.server.v1_10_R1.Packet");
            ...
            String error = "An error has occured while sending an NMS action bar for v1_10_R1!";
            print(error);
            ex.printStackTrace();
        }
    }
