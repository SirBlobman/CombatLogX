...
public class LegacyHandler_1_9_R2 extends LegacyHandler {
    ...
    public void sendActionBar(Player player, String msg) {
        try {
            ...
            Class<?> class_IChatBaseComponent = Class.forName("net.minecraft.server.v1_9_R2.IChatBaseComponent");
            Class<?> class_ChatSerializer = getInnerClass(class_IChatBaseComponent, "ChatSerializer");
            Class<?> class_CraftPlayer = Class.forName("org.bukkit.craftbukkit.v1_9_R2.entity.CraftPlayer");
            Class<?> class_PacketPlayOutChat = Class.forName("net.minecraft.server.v1_9_R2.PacketPlayOutChat");
            Class<?> class_EntityPlayer = Class.forName("net.minecraft.server.v1_9_R2.EntityPlayer");
            Class<?> class_PlayerConnection = Class.forName("net.minecraft.server.v1_9_R2.PlayerConnection");
            Class<?> class_Packet = Class.forName("net.minecraft.server.v1_9_R2.Packet");
