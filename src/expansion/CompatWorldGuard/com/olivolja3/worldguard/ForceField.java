	...
	public void updateViewedBlocks(PlayerMoveEvent e) {
		...
		if (t.getBlockX() == f.getBlockX() && t.getBlockY() == f.getBlockY() && t.getBlockZ() == f.getBlockZ()) return;
				...
				for (Location location : changedBlocks) {
					p.sendBlockChange(location, Material.getMaterial(utils.getMaterial(ConfigWorldGuard.OPTION_FORCEFIELD_MATERIAL)), utils.getData(ConfigWorldGuard.OPTION_FORCEFIELD_MATERIAL));
