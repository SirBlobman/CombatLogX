...
import com.SirBlobman.combatlogx.expansion.compatibility.factions.listener.ListenerForceField;
...
public final class HookForceField {
    ...
    public static void onConfigLoad(CompatibilityFactions expansion) {
    ...
    public static void checkValidForceField(CompatibilityFactions expansion, FactionsHook factionsHook) {
        ...
        ListenerForceField forceField = new ListenerForceField(expansion, factionsHook);
