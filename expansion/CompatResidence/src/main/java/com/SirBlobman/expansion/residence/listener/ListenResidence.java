...
public class ListenResidence implements Listener {
    ...
    private Vector getVector(Location fromLoc, Location toLoc) {
        ...
        Vector multiply = normal.multiply(ConfigResidence.NO_ENTRY_KNOCKBACK_STRENGTH);
    ...
    private void preventEntry(Cancellable e, Player player, Location fromLoc, Location toLoc) {
        ...
        NoEntryMode nemode = ConfigResidence.getNoEntryMode();
    ...
    public static void sendMessage(Player player, LivingEntity enemy) {
        ...
        SchedulerUtil.runLater(ConfigResidence.MESSAGE_COOLDOWN * 20L, () -> MESSAGE_COOLDOWN.remove(uuid));
    }
}