...
public class ListenNotifier implements Listener {
	...
	public void onTimerChange(PlayerCombatTimerChangeEvent e) {
		...
		if(ConfigNotifier.SCORE_BOARD_ENABLED) ScoreboardUtil.updateScoreBoard(player);
	}
	...
	public void onUntag(PlayerUntagEvent e) {
		...
		if(ConfigNotifier.SCORE_BOARD_ENABLED) ScoreboardUtil.removeScoreBoard(player);
	}
}